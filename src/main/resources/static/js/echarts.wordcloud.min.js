!(function(t, e) {
  ...
  return (function(t) {
      ...
      (_.prototype = {
        ...
        getBoundingRect: function() {
          ...
          for (
            ...
            var v = t[l++];
            switch ((1 == l && ((e = t[l]), (r = t[l + 1]), (n = e), (s = r)),
            v)) {
              case h.M:
                (n = t[l++]),
                  (s = t[l++]),
        ...
        rebuildPath: function(t) {
          for (
            ...
            var d = s[f++];
            switch ((1 == f && ((n = s[f]), (i = s[f + 1]), (e = n), (r = i)),
            d)) {
              case h.M:
    ...
    function(t, e, r) {
      ...
      function a(t, e) {
        ...
        return "string" == typeof t
          ? n(t).match(/%$/) ? parseFloat(t) / 100 * e : parseFloat(t)
          : null == t ? NaN : +t;
      }
      function o(t, e, r) {
        return (
      ...
      function m(t, e) {
        ...
        return (
          (r = e
            ? a < 1.5 ? 1 : a < 2.5 ? 2 : a < 4 ? 3 : a < 7 ? 5 : 10
            : a < 1 ? 1 : a < 2 ? 2 : a < 3 ? 3 : a < 5 ? 5 : 10),
          (t = r * i),
    ...
    function(t, e, r) {
      ...
      function x(t, e) {
        return "string" == typeof t
          ? t.lastIndexOf("%") >= 0 ? parseFloat(t) / 100 * e : parseFloat(t)
          : t;
      }
      function y(t, e, r) {
        return "right" === e
          ? t - r[1]
          : "center" === e ? t + r[3] / 2 - r[1] / 2 : t + r[3];
      }
      function w(t, e) {
        return (
          null != t &&
    ...
    function(t, e, r) {
      ...
      function a(t, e, r) {
        ...
        isNaN(u) && (u = i - l - c - o),
        null != p &&
          (isNaN(h) && isNaN(u) && (p > n / i ? (h = 0.8 * n) : (u = 0.8 * i)),
          isNaN(h) && (h = p * u),
          isNaN(u) && (u = h / p)),
        isNaN(a) && (a = n - s - h - d),
        isNaN(o) && (o = i - l - u - c),
        ...
        k = {
          ...
          getFormattedLabel: function(t, e, r, n, i) {
            ...
            return "function" == typeof l
              ? ((s.status = e), l(s))
              : "string" == typeof l ? w.formatTpl(l, s) : void 0;
          },
    ...
    function(t, e, r) {
        ...
        for (var f, d, v = 0, g = -1, p = 0; p < c; p++) {
          ...
          x.cubicAt(t, r, a, s, m) < h ||
            ...
            2 == g
              ? m < M[0]
                ? (v += f < e ? y : -y)
                : m < M[1] ? (v += d < f ? y : -y) : (v += l < d ? y : -y)
              : m < M[0] ? (v += f < e ? y : -y) : (v += l < f ? y : -y));
        }
        return v;
      }
      function o(t, e, r, n, i, a, o, s) {
      ...
      function l(t, e, r, i, l) {
        for (var h = 0, u = 0, c = 0, p = 0, m = 0, x = 0; x < t.length; ) {
          var _ = t[x++];
          switch ((_ === w.M && x > 1 && (r || (h += y(u, c, p, m, i, l))),
        ...
        (function(r) {
          var a = (function() {
              ...
              return (
                !!e.getImageData &&
                (!!e.fillText &&
                  (!!Array.prototype.some && !!Array.prototype.push))
              );
            })(),
            o = (function() {
              if (a) {
