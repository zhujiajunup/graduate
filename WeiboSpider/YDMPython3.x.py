...
YDMApi = windll.LoadLibrary('D:\\graduate\\WeiboSpider\\dll\\yundamaAPI-x64.dll')
...
username = b'zhujiajun'
password = b'vs7452014'
...
# 验证码文件路径
filename = b'D:\\graduate\\WeiboSpider\\img\\verify_code.png'
