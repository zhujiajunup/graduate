    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            dom.innerHTML = '<div class="panel-body">\n' +
                ...
                '                                     style="width: 134px; height: 134px; line-height: 134px;display: inline-block;">\n' +
                '                                    <div class="thumb-lg">\n' +
                ...
                '                                </div>\n' +
                '                                <div class="h4 m-t m-b-xs" style="font-size: 18px;">'+result.data['nickname'] + '</div>\n' +
                ...
                '                            <div class="col-xs-4">\n' +
                '                                <div class="padder-v">\n' +
                '                                    <span class="m-b-xs h3 block text-white" style="font-size: 18px;">'+followNum + '</span>\n' +
                '                                    <small class="text-muted">关注</small>\n' +
                '                                </div>\n' +
                '                            </div>\n' +
                '                            <div class="col-xs-4 dk">\n' +
                '                                <div class="padder-v">\n' +
                '                                    <span class="m-b-xs h3 block text-white" style="font-size: 18px;">'+fansNum+ '</span>\n' +
                '                                    <small class="text-muted">粉丝</small>\n' +
                '                                </div>\n' +
                '                            </div>\n' +
                '                            <div class="col-xs-4">\n' +
                '                                <div class="padder-v">\n' +
                '                                    <span class="m-b-xs h3 block text-white" style="font-size: 18px;">'+tweetNum+'</span>\n' +
