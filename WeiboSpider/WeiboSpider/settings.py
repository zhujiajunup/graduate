...
"""
Django settings for Jpider project.
...
SECRET_KEY = '$v@3$86$0^8cney1sk%ln+aa+zf!x@=6bhs$u1&ka(*!i%vub$'
...
WSGI_APPLICATION = 'Jpider.wsgi.application'
